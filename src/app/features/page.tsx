        ...
        <Container>
          <div className="flex h-16 items-center justify-between">
            ...
            <div className="hidden items-center gap-8 text-sm text-brand-muted md:flex">
              ...
              <Link className="group relative font-medium hover:text-brand-ink transition-colors" href="/#plans">
                Plans
                <span className="absolute -bottom-4 left-0 h-[3px] w-0 rounded-full bg-brand-accent transition-all duration-300 group-hover:w-full" />
              </Link>
              <Link className="group relative font-medium hover:text-brand-ink transition-colors" href="/#support">
                Support
                <span className="absolute -bottom-4 left-0 h-[3px] w-0 rounded-full bg-brand-accent transition-all duration-300 group-hover:w-full" />
              </Link>
            </div>
